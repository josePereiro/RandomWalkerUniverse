...
public class _MiddleRightPointTest extends PApplet {

    public static void main(String... args) {
        //Write your own main class path
        PApplet.main("Core.Engine.Tools._MiddleRightPointTest");
    }
    ...
    public void draw() {
        ...
        background(255);
        noCursor();
        Vector rightMiddlePoint = Tools.getMiddleRightPoint(width / 2, height / 2, mouseX, mouseY);
        stroke(0);
