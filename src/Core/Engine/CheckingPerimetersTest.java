...
public class CheckingPerimetersTest extends PApplet {

    public static void main(String... args) {
        //Write your own main class path
        PApplet.main("Core.Engine.CheckingPerimetersTest");
    }
    ...
    public void draw() {
        ...
        if (board.checkCircularPerimeter(x, y, 10) ||
                board.checkCircularPerimeter(x,y,9)) {
            noStroke();
